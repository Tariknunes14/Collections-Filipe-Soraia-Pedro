...
public class QueueCollection<T> implements Queue<T> {//corrigir meter <T> no queue e depois corrigir os outros metodos

    //array for the data structure
    private Object[] array;

    //Constructor to get a size for the array
    public QueueCollection(int number) {
    ...
    public boolean remove() {
        ...
        //if there's no null it will get the last position and removes that one
